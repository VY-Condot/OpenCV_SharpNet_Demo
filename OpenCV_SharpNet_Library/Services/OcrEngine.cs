...
using OpenCV_SharpNet.Services._1D_BarCode;
using OpenCvSharp;
...
namespace OpenCV_SharpNet.Services
{
    public static class OcrEngine
    {
        ...
        // Z-XING OPTIONS
        // =========================================================
        public static TextMode BarCodeTextMode => TextMode.HRI;
            ...
            try
            {
                ...
                switch (roi.Type)
                {
                    ...
                    case RoiType.Barcode:
                        ...
                        {
                            roi.Gs1QcResult = new OpenCV_SharpNet.Models.GS1_QC.GS1_QC_CheckResult();
                        }
